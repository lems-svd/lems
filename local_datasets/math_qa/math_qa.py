...
"""
#_URL = os.path.join(os.path.dirname(os.path.abspath(__file__)), "MathQA")
_URL = "/workspace/KFAC-SVD/local_datasets/math_qa/MathQA" # "https://math-qa.github.io/math-QA/data/MathQA.zip"
# ABS PATH IS SAFER!!!
print(_URL)

# sudo nano /opt/conda/lib/python3.10/site-packages/lm_eval/tasks/mathqa.py 
# DATASET_PATH = "/workspace/KFAC-SVD/math_qa/math_qa_modified.py"
...
class MathQa(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        dl_path = _URL #dl_manager.download_and_extract(_URL)
        return [
